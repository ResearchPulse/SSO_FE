...
export default function AuthCallbackPage() {
  ...
  return <main className="callback-page"><section className="callback-card" aria-live="polite">
    ...
    {!state.loading && state.error && <><p className="eyebrow">SSO ERROR</p><h1>Không thể xác nhận đăng nhập</h1><p>{state.error}</p><Link className="callback-link" href="/">Quay lại đăng nhập</Link></>}
  </section></main>;
}
