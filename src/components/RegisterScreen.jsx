          ...
          <div className="form-shell register-shell">
            ...
            <form onSubmit={submit} noValidate>
              ...
              <div className="register-grid register-grid--details">
                ...
                <div className="field-group"><label>Gender</label><div className="segmented-control"><button type="button" className={form.gender === 'male' ? 'is-selected' : ''} onClick={() => update('gender', 'male')}>Male</button><button type="button" className={form.gender === 'female' ? 'is-selected' : ''} onClick={() => update('gender', 'female')}>Female</button></div></div>
              </div>
